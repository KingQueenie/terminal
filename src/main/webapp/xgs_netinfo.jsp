...
<div class="search_tab form-horizontal">
    <div class="row">
                ...
                <div class="col-xs-7" >
                    <select id="opType" class="form-control">
                    	<option value="0"></option>
            				...
            				<option value="2">sento</option>
            				<option value="3">connect</option>
            				<option value="4">send</option>
            				<option value="5">recv</option>
            				<option value="6">recvfrom</option> 
        ...
        <div class="col-xs-3">
            <div class="form-group">
                <div class="col-xs-5 text-right">
                    <label class="control-label" for="dataProtocol">进程ID：</label>
                </div>
                <div class="col-xs-7">
                    <input type="text" class="form-control"id="dataProtocol" />
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="scripts/netinfo.js"></script>
</html>