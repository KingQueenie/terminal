...
<div class="search_tab form-horizontal">
    <div class="row">
        ...
        <div class="col-xs-3">
            <div class="form-group">
                <div class="col-xs-6 text-right">
                    <label class="control-label" for="pendingProcessID">被挂起线程：</label>
                </div>
                <div class="col-xs-6">
    ...
    <div class="row">
    	<div class="col-xs-3">
            <div class="form-group">
                <div class="col-xs-6 text-right">
                    <label class="control-label" for="dependProcessName">被挂起线程依附进程名：</label>
                </div>
                <div class="col-xs-6">
        ...
        <div class="col-xs-3">
            <div class="form-group">
                <div class="col-xs-6 text-right">
                    <label class="control-label" for="dependProcessID">被挂起线程依附进程ID：</label>
                </div>
                <div class="col-xs-6">
...
<script src="scripts/netopinfo3.js"></script>
</html>