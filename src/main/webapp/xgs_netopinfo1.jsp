...
<div class="search_tab form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-7" >
                    <select id="opType" class="form-control">
              			...
              			<option value="1">结束当前进程</option>
		                <option value="2">结束另一进程</option>
		                <option value="3">创建进程</option>
		                <option value="4">挂起进程</option>
		                <option value="5">恢复进程</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <div class="row">
    	<div class="col-xs-3">
            <div class="form-group">
                <div class="col-xs-5 text-right">
                    <label class="control-label" for="objectProcessName">被操作进程名：</label>
                </div>
                <div class="col-xs-7">
                    <input type="text" class="form-control"id="objectProcessName" />
                </div>
            </div>
        </div>
        <div class="col-xs-3">
            <div class="form-group">
                <div class="col-xs-5 text-right">
                    <label class="control-label" for="objectProcessID">被操作进程ID：</label>
                </div>
                <div class="col-xs-7">
                    <input type="text" class="form-control"id="objectProcessID" />
                </div>
            </div>
        </div>
        <div class="col-xs-3">
...
<script src="scripts/netopinfo1.js"></script>
</html>