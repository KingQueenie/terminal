		    ...
		    <div class="form-group">
		        ...
		        <div class="col-xs-7" >
		            <select id="opType" class="form-control">
		                ...
		                <option value="1" label="">读文件</option>
		                <option value="2" label="">写文件</option>
		                <option value="3" label="">创建文件</option>
		                <option value="4" label="">打开文件</option>
		                <option value="5" label="">删除文件</option>
		                <option value="6" label="">CreateSection</option>
		                <option value="7" label="">MapView</option>
		                <option value="8" label="">UnmapView</option>
		                <option value="9" label="">重命名</option>
		                <option value="10" label="">删除目录</option>
		            </select>
		        </div>
		    </div>
		</div>
...
<script type="text/javascript" src="scripts/fileOpinfo1.js"></script>
</html>