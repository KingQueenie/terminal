            ...
            <div class="form-group">
                ...
                <div class="col-xs-7" >
                    <select id="opType" class="form-control">
              			...
              			<option value="1">创建键值</option>
              			<option value="2">打开键值</option>
		                <option value="3">删除键值</option>
		                <option value="4">重命名键值</option>
                    </select>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="scripts/registryopinfo1.js"></script>
</html>